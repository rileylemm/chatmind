...
class ChatSimilarityCalculator:
    ...
    def __init__(self, input_file: str = "data/processed/processed_tagged_chunks.jsonl"):
...
@click.command()
@click.option('--input-file', default='data/processed/processed_tagged_chunks.jsonl', 
