...
This script:
1. Loads tagged chunks from data/processed/tagged_chunks.jsonl
...
6. Saves updated data to data/processed/topics_with_coords.jsonl
"""
...
def apply_topic_layout(input_file: Path = None, output_file: Path = None) -> bool:
    ...
    if output_file is None:
        output_file = Path("data/processed/topics_with_coords.jsonl")
